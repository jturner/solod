...
func testResolveNamedPort() {
	print("- resolve a named port...")
...
func testResolveHostname() {
	print("- resolve a hostname...")
...
func testResolveFamilyMismatch() {
	print("- resolve family mismatch...")
...
func testListenAll() {
	print("- listen on all interfaces...")
...
func testClearDeadline() {
	print("- clear deadline...")

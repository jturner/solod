...
func intPow10(e int) pow10Result {
	if e < pow10Min || e > pow10Max {
		return pow10Result{}
	}
	mant := pow10Tab[e-pow10Min]
	exp := 1 + mulLog2_10(e)
...
func trimZeros(x uint64) (uint64, int) {
	const (
		div1e8m  uint64 = 0xc767074b22e90e21
		div1e8le        = maxUint64 / 100000000

		div1e4m  uint64 = 0xd288ce703afb7e91
		div1e4le        = maxUint64 / 10000

		div1e2m  uint64 = 0x8f5c28f5c28f5c29
		div1e2le        = maxUint64 / 100

		div1e1m  uint64 = 0xcccccccccccccccd
